...
export interface CryptoEngine {
   ...
   * @param keyId The identifier of the key that is used to encrypt sensitive data. Retrieved from the Worldline Connect Client API.
   * @param publicKey The public key that is used to encrypt the sensitive data with. Retrieved from the Worldline Connect Client API.
