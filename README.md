...
* [AccountOnFileDisplayHints](https://robtimus.github.io/connect-client-sdk-ts/interfaces/model.AccountOnFileDisplayHints.html) has some label template related utility methods. Logos are objects containing the path originally returned by the Worldline Connect Client API and an absolute URL starting with the asset URL. These objects also support creating URLs that specify dimensions.
...
* [PaymentProductDisplayHints](https://robtimus.github.io/connect-client-sdk-ts/interfaces/model.PaymentProductDisplayHints.html) logos are objects containing the path originally returned by the Worldline Connect Client API and an absolute URL starting with the asset URL. These objects also support creating URLs that specify dimensions.
